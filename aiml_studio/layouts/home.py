...
def create_home_layout() -> html.Div:
    ...
    """
    quick_actions = [
        {"title": "Analytics", "description": "View analytics dashboard", "icon": "tabler:chart-bar", "href": "/analytics"},
        {"title": "Data Sources", "description": "Manage data connections", "icon": "tabler:database", "href": "/data-sources"},
    ...
    recent_activity_data = [
        ...
        {"timestamp": "2024-01-22 09:15:00", "action": "Data Source Added", "details": "Connected to PostgreSQL database"},
