                                        ...
                                        [
                                            dmc.Stack(
                                                [
                                                    dmc.Group(
                                                        [
                                                            DashIconify(icon="tabler:folder-filled", width=24, color="blue"),
                                                            dmc.Badge(
                                                                project["status"],
                                                                color="green" if project["status"] == "Active"
                                                                else "blue" if project["status"] == "Completed"
                                                                else "gray",
                                                            ),
                                                        ],
                                                        justify="space-between",
                                                    ...
                                                    dmc.Group(
                                                        [
                                                            ...
                                                            dmc.Text(f"Modified: {project['modified']}", size="xs", c="dimmed"),
                                                        ],
                                                        gap="xs",
                                                        wrap="wrap",
                                                    ),
